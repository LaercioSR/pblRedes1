...
public class FXMLTelaController implements Initializable {
    ...
    public void carregarAnchorPaneConfiguracoes() throws  IOException {
        ...
        loader.setLocation(getClass().getResource("FXMLAnchorPaneConfiguracoesTermometro.fxml"));
        a = loader.load();
    ...
    public void carregarAnchorPaneTermometro() throws  IOException {
        AnchorPane a;
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("FXMLAnchorPaneTermometro.fxml"));
        a = loader.load();
