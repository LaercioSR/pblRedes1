...
import br.uefs.ecomp.atuadores.arCondicionado.view.ArCondicionado;
...
public class FXMLTelaArCondicionadoController implements Initializable {
    ...
    private FXMLAnchorPaneConfiguracoesArCondicionadoController controllerConfiguracoes;
    private FXMLAnchorPaneArCondicionadoController controllerArCondicionado;
    ...
    public void carregarAnchorPaneConfiguracoes() throws IOException {
        ...
        loader.setLocation(getClass().getResource("/br/uefs/ecomp/atuadores/arCondicionado/view/FXMLAnchorPaneConfiguracoesArCondicionado.fxml"));
    ...
    public void carregarAnchorPaneArCondicionado() throws  IOException {
        AnchorPane a;
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/br/uefs/ecomp/atuadores/arCondicionado/view/FXMLAnchorPaneArCondicionado.fxml"));
